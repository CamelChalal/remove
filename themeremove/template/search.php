...
<?php $search = new WP_Query(array('s' => $_GET['termtosearch'], 'post_type' => array('POST', 'page', 'article', 'presse', 'projet'), 'orderby' => 'date', 'posts_per_page' => '-1')); ?>
                    ...
                    <div class="card recherche1__div">
                        <div class="card-body card_resultat_recherche">
                            <a class="" href="<?php the_permalink(); ?>">
                                <p id="result__title">
                                    <b><?php echo get_post_type(); ?> : </b><?php the_title(); ?> : <?php the_excerpt(); ?>
                                </p>
                            </a>
                        </div>
                    </div>
